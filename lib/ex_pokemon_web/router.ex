defmodule ExPokemonWeb.Router do
  use ExPokemonWeb, :router
  ...
  pipeline :auth do
    plug ExPokemonWeb.Auth.Pipeline
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: ExPokemonWeb.Telemetry
    end
  end
